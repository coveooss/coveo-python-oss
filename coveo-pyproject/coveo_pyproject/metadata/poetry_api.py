...
class Dependency:
    ...
    def __init__(self, name: str, optional: bool = False, path: Union[Path, str] = None, version: str = "*",
                 extras: List[str] = None, source: str = None, allow_prerelease: bool = None) -> None:
        # set some defaults
        self.name = name
...
class PoetryAPI:
    ...
    def __init__(self, *,
                 name: str, version: str, description: str, authors: Iterable[str],
                 dependencies: Mapping[str, Any] = None, dev_dependencies: Mapping[str, Any] = None,
...
def dependencies_factory(dependencies: Mapping[str, Union[str, dict]] = None) -> Dict[str, Dependency]:
    ...
    return {name: Dependency.factory(name, dependency) for name, dependency in dependencies.items()} \
