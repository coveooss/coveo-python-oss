...
@UnitTest
@parametrize(['releases', 'minimum_version', 'expected_next_version', 'expected_next_prerelease'], (
    pytest.param(
        [],
        None,
        '0.0.1',
    ...
    pytest.param(
        [StrictVersion('0.0.1')],  # simple case
        '0.4',
        '0.4.0',
        'a1',
        id='simple case'
...
def test_next_version(releases: Sequence[StrictVersion], minimum_version: str,
                      expected_next_version: str, expected_next_prerelease: str) -> None:
    ...
    with requests_mock.Mocker() as http_mock:
        ...
        assert str(compute_next_version('mocked', prerelease=True, **kwargs)) == \
