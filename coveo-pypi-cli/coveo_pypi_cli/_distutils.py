"""
This is a copy of the old distutils.version module, which is deprecated.
We need to migrate to packaging.version, but it's not a trivial change.

note: the deprecation warning has been removed.
"""
