...
def find_annotations(thing: Union[Type, Callable], globalns: Dict[str, Any] = None) -> Dict[str, Type]:
    ...
    if isinstance(thing, type):
        ...
        for kls in reversed(thing.__mro__):  # we iterate from least (object()) to most significant base.
